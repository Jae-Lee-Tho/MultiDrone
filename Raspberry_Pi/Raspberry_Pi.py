...
class DroneController:
    ...
    def apply_command(self, command: Command):
        ...
        if self.drone_state is DroneState.GROUNDED:
            ...
            # -----------------------------------------------------------------
            # ✏️ TUNE: HOVER THROTTLE
            # Needs to be found via the calibrate_rc.py script.
            # 1000 = Motors off, 2000 = Max thrust.
            # -----------------------------------------------------------------
            ...
            # -----------------------------------------------------------------
            # ✏️ TUNE: MOVEMENT SPEEDS
            # 1500 is neutral. Lower is backward/left. Higher is forward/right.
            # E.g., 1600 is mild forward. 1900 is extremely aggressive forward.
            # -----------------------------------------------------------------
